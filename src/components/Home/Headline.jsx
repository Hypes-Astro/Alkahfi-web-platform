    ...
    <div className="w-full pt-5 px-6   ">
      <div className="content bg-blue-50 p-2 rounded-md flex sm:flex-row justify-between h-full ">
        ...
        <div className="titleHeader flex flex-col relative w-full ">
            <a href="https://maps.app.goo.gl/H7VGMirotSSSkxed9" target="_blank" rel="noopener noreferrer" className="mb-5 sm:w-[22rem]">
            ...
            <p className="mt-5 text-base sm:text-lg text-justify md:w-[55%]">Your daily life is a place of worship and your religion. When you enter it, enter with all your heart and soul. - Kahlil Gibran</p>
      ...
      <CardSholatToday jadWalSholatToday={dataJadwalSholat} />
